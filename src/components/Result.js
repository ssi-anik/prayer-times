            ...
            <div className="container-fluid">
                <div className="col-md-6">
                    <Table timings={timingsToday}
                           caption={`Today - ${this.formatToDateFromTimestamp(today)}'s prayer times`} extra={this.formatToDateFromTimestamp(today)}/>
                </div>
                
                <div className="col-md-6">
                    <Table timings={timingsTomorrow}
                           caption={`Tomorrow - ${this.formatToDateFromTimestamp(tomorrow)}'s prayer times`} extra={this.formatToDateFromTimestamp(tomorrow)}/>
                </div>
            </div>
        );
    }
